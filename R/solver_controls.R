.add_controls <- function(solver) {
    ...
    ROI_plugin_register_solver_control(solver, "ConcurrentSettings", "X") # Create concurrent environments from a list of .prm files
    ...
    ROI_plugin_register_solver_control(solver, "NonConvex"         , "X") # Control how to deal with non-convex quadratic programs
    ROI_plugin_register_solver_control(solver, "NoRelHeurTime"     , "X") # Limits the amount of time (in seconds, "X") spent in the NoRel heuristic
    ROI_plugin_register_solver_control(solver, "NoRelHeurWork"     , "X") # Limits the amount of work performed by the NoRel heuristic
    ROI_plugin_register_solver_control(solver, "PartitionPlace"    , "X") # Controls when the partition heuristic runs
    ...
    ROI_plugin_register_solver_control(solver, "SolFiles"          , "X") # Location to store intermediate solution files
    ROI_plugin_register_solver_control(solver, "SolutionNumber"    , "X") # Sub-optimal MIP solution retrieval
    ROI_plugin_register_solver_control(solver, "StartNodeLimit"    , "X") # Node limit for MIP start sub-MIP
    ROI_plugin_register_solver_control(solver, "StartNumber"       , "X") # Set index of MIP start
    ...
    ROI_plugin_register_solver_control(solver, "PreSOS1BigM"   , "X") # Controls SOS1 conversion to binary form
    ROI_plugin_register_solver_control(solver, "PreSOS2BigM"   , "X") # Controls SOS2 conversion to binary form
    ROI_plugin_register_solver_control(solver, "PreSparsify"   , "X") # Presolve sparsify reduction

    # Tuning
    ROI_plugin_register_solver_control(solver, "TuneBaseSettings", "X") # Comma-separated list of base parameter settings
    ROI_plugin_register_solver_control(solver, "TuneCleanup"     , "X") # Enables a tuning cleanup phase
    ...
    # Multiple Solutions
    ROI_plugin_register_solver_control(solver, "PoolGap"       , "X") # Relative gap for solutions in pool
    ROI_plugin_register_solver_control(solver, "PoolGapAbs"    , "X") # Absolute gap for solutions in pool
    ...
    # MIP Cuts
    ROI_plugin_register_solver_control(solver, "BQPCuts"        , "X") # BQP cut generation
    ...
    ROI_plugin_register_solver_control(solver, "PSDCuts"        , "X") # PSD cut generation
    ROI_plugin_register_solver_control(solver, "RelaxLiftCuts"  , "X") # Relax-and-lift cut generation
    ROI_plugin_register_solver_control(solver, "RLTCuts"        , "X") # RLT cut generation
    ...
    ROI_plugin_register_solver_control(solver, "FuncPieceError"  , "X") # Error allowed for PWL translation of function constraint
    ROI_plugin_register_solver_control(solver, "FuncPieceLength" , "X") # Piece length for PWL translation of function constraint
    ROI_plugin_register_solver_control(solver, "FuncPieceRatio"  , "X") # Controls whether to under- or over-estimate function values in PWL approximation
    ROI_plugin_register_solver_control(solver, "FuncPieces"      , "X") # Sets strategy for PWL function approximation
    ROI_plugin_register_solver_control(solver, "FuncMaxVal"      , "X") # Maximum value for x and y variables in function constraints
    ROI_plugin_register_solver_control(solver, "IgnoreNames"     , "X") # Indicates whether to ignore names provided by users
    ...
    ROI_plugin_register_solver_control(solver, "IntegralityFocus", "X") # Set the integrality focus
    ROI_plugin_register_solver_control(solver, "JSONSolDetail"   , "X") # Controls the level of detail stored in generated JSON solution
    ...
    ROI_plugin_register_solver_control(solver, "MultiObjSettings", "X") # Create multi-objective settings from a list of .prm files
    ...
    ROI_plugin_register_solver_control(solver, "ScenarioNumber"  , "X") # Set index of scenario in multi-scenario models
